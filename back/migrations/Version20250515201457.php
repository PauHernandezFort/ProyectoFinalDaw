 ...
 */
final class Version20250515201457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE chat (id INT AUTO_INCREMENT NOT NULL, usuaio_1_id INT DEFAULT NULL, usuario_2_id INT DEFAULT NULL, INDEX IDX_659DF2AAD3A1383C (usuaio_1_id), INDEX IDX_659DF2AA8B1C8904 (usuario_2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE mensaje (id INT AUTO_INCREMENT NOT NULL, remitente_id_id INT DEFAULT NULL, chat_id_id INT DEFAULT NULL, contenido VARCHAR(255) DEFAULT NULL, fecha_envio DATE DEFAULT NULL, INDEX IDX_9B631D01D5EDFE14 (remitente_id_id), INDEX IDX_9B631D017E3973CC (chat_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
